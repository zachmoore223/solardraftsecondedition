...
$gameinfos = [
    ...
    'game_name' => "Solar Draft - Second Edition",

    // Game publisher (use empty string if there is no publisher)
    'publisher' => 'Grumlin Games',

    // Url of game publisher website
    'publisher_website' => 'https://grumlingames.com/',

    // Board Game Geek ID of the publisher
    'publisher_bgg_id' => 55114,
    ...
    'tie_breaker_description' => "Most rings in solar system.",
